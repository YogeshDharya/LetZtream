...
const SearchVideo=(props)=>{
    ...
    return(
        ...
        size="small"
        fullWidth
        sx={{ input: { color: '#FFFFFF',borderColor:'grey', outlineColor:'grey'}, background:'#121212',"& .MuiOutlinedInput-root": {"& > fieldset": { borderColor: "gray" }}, "&:hover":{"& .MuiOutlinedInput-root": {"& > fieldset": { borderColor: "gray" }}}}} 
        InputProps={{
            endAdornment: (
